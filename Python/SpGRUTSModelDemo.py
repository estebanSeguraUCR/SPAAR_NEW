...
# Example: runfile("SpGRUTSModelDemo.py","'../DataSets/signal_with_anomaly.csv' 300 20 3400 0.15 16 0.3")
# Example: runfile("SpGRUTSModelDemo.py","'../DataSets/signal_with_anomaly.csv' 30 60 880 0.1 16 0.3")
import sys
"""
